...
function Home() {
  return (
    <div>
      <Row className='mb-5' style={{height:'80vh'}}>
        ...
        <button className='btn btn-danger rounded me-5 px-4 py-3'>Join for Free</button>
        <button className='btn btn-danger rounded px-4 py-3'><FontAwesomeIcon icon={faPlay}  className='me-2'/> Learn how</button>
        </div>
        </div>
        </Col>
        <Col sm={12} md={6} style={{marginTop:'120px'}}>
