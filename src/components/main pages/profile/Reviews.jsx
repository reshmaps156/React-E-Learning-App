      ...
      <div className='col-md-10 col-12'>
        <div className='d-flex justify-content-between row w-100'>
            ...
            <div className='ms-3  col-md-4  w-100'>
                ...
                <h6 className='fw-bold '>Ratings : {selectedStarCount}/5</h6>
